...
export default function ShopCard() {
  // const clothes = [
  //   {
  //     image: "assets/img/clothes/3men.jpg",
  //   },
  //   {
  //     image: "assets/img/clothes/1men.webp",
  //   },
  //   {
  //     image: "assets/img/clothes/2women.jpg",
  //   },
  //   {
  //     image: "assets/img/clothes/2men.webp",
  //   },
  //   {
  //     image: "assets/img/clothes/1women.jpg",
  //   },
  //   {
  //     image: "assets/img/clothes/3women.webp",
  //   },
  // ];
  // {
  //  return clothes.map(({ image }) => {
      return (
        <>
          <div className="men1 w-52 border bg-white  hover:bg-gray-100 hover:opacity-80 rounded active:bg-gray-200 shadow cursor-pointer">
            <div className="image flex justify-center p-2">
              <div className="border">
                <img src={"assets/img/clothes/3men.jpg"} alt="" className="h-36 {sm:h-56}" />
              </div>
            </div>
