...
export default function ShopCard() {
  ...
  const clothes = [
    {
      image_1: "assets/img/clothes/frontshirt.jpg",
    },
    {
      image_2: "assets/img/clothes/backshirt.jpg",
    },
  ];
  {
          ...
          onMouseLeave={() => setRotate(false)}>
            ...
            onMouseOver={() => setRotate(true)}>
              <div className="border">
                {/* {clothes.map(({image_1, image_2}) => {
                  return                
                })} */}

<img src={`${rotate ? "assets/img/clothes/backshirt.jpg" : "assets/img/clothes/frontshirt.jpg"}`} alt="" className={`h-36 w-36 object-cover {sm:h-56} rounded`} />
              </div>
            </div>
